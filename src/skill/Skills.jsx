...
import frontendSkill from "../constants/constants";
import { backendSkill, techTools } from "../constants/constants";
...
const Skills = () => {
  return (
    <div id="aboutMe" className="flex relative">
      <div className="max-lg:hidden w-1/2 h-[63rem] bg-[#181818] absolute z-0"></div>
      <Contentwrapper>
